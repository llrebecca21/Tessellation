...
library(mcmcse)
set.seed(100)
source("R/Model_2/posterior_hierarch_Lambda.R")
source("R/Model_2/gradient_hierarch_Lambda.R")
source("R/Model_2/he_hierarch_Lambda.R")
source("R/Chol_sampling.R")
source("R/arma_spec.R")
source("R/Model_2/Sim_hierarch_Lambda.R")
